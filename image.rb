...
class ImageWriter
  class << self
    ...
    def get_b1(image, x, y)
      0 +
        ...
        0b00000100 * get(image,x,y+4) +
        0b00001000 * get(image,x,y+6) +
        0b00010000 * get(image,x,y+8) +
        0b00100000 * get(image,x,y+10) +
        0b01000000 * get(image,x,y+12) +
        0b10000000 * get(image,x,y+14)
    end
    ...
    def get_b2(image, x, y)
      0 +
        ...
        0b00000100 * get(image,x,y+5) +
        0b00001000 * get(image,x,y+7) +
        0b00010000 * get(image,x,y+9) +
        0b00100000 * get(image,x,y+11) +
        0b01000000 * get(image,x,y+13) +
        0b10000000 * get(image,x,y+15)
    end
  end
  ...
  def print!
    img = @img
    double_passes = (img.height / 16).ceil
